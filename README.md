...
![Expenses overview](documents/screenshots/expenses-overview.png)

**Insurance — policy manager**
![Insurance policies](documents/screenshots/insurance-policies.png)

**Insurance — AI coverage checker**
![Coverage checker](documents/screenshots/coverage-checker.png)
