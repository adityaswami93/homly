"""soft delete (legacy migration 002_soft_delete.sql)

Wraps backend/migrations/002_soft_delete.sql verbatim -- see backend/migrations/README.md
...
down_revision: Union[str, None] = '001_homly'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

_LEGACY_SQL = Path(__file__).resolve().parent.parent.parent / "migrations" / '002_soft_delete.sql'
