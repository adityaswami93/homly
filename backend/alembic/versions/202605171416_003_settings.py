"""settings (legacy migration 003_settings.sql)

Wraps backend/migrations/003_settings.sql verbatim -- see backend/migrations/README.md
...
revision: str = '003_settings'
down_revision: Union[str, None] = '002_soft_delete'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

_LEGACY_SQL = Path(__file__).resolve().parent.parent.parent / "migrations" / '003_settings.sql'
