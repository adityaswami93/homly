"""multi tenant (legacy migration 006_multi_tenant.sql)

Wraps backend/migrations/006_multi_tenant.sql verbatim -- see backend/migrations/README.md
...
down_revision: Union[str, None] = '004_sender'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

_LEGACY_SQL = Path(__file__).resolve().parent.parent.parent / "migrations" / '006_multi_tenant.sql'
