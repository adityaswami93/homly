"""image storage (legacy migration 014_image_storage.sql)

Wraps backend/migrations/014_image_storage.sql verbatim -- see backend/migrations/README.md
...
Revision ID: 014_image_storage
Revises: 013_reimbursement
...
revision: str = '014_image_storage'
down_revision: Union[str, None] = '013_reimbursement'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

_LEGACY_SQL = Path(__file__).resolve().parent.parent.parent / "migrations" / '014_image_storage.sql'
