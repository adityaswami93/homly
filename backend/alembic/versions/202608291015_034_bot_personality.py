"""bot personality + engagement settings (034_bot_personality.sql)
...
backend/migrations/034_bot_personality.sql.

Revision ID: 034_bot_personality
Revises: 033_reimbursement_receipt_link
Create Date: 2026-08-24T10:15:00+00:00
"""
...
revision: str = '034_bot_personality'
down_revision: Union[str, None] = '033_reimbursement_receipt_link'
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

_LEGACY_SQL = Path(__file__).resolve().parent.parent.parent / "migrations" / '034_bot_personality.sql'
