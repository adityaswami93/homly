...
| 038 | landing-page-positioning | Landing page rewritten from "expense tracker" to household concierge (home + money), redesigned for hierarchy, plus a 50/50 hero A/B test recorded on `waitlist.variant` | 🔄 In Review |
