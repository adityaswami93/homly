...
function PriceIntelligenceTab() {
  ...
  if (loading) return <p className="text-stone-600 text-sm py-12">Loading price intelligence...</p>;
  if (!data) return <p className="text-stone-600 text-sm py-12">No data available.</p>;
  ...
  // Group by canonical_name and compute per-item min/max avg price for highlights
  ...
  // Track which canonical_name was last rendered to show name only on first row
  let lastItemName = "";
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Section 3 — Cheapest store by category */}
