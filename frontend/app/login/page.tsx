            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-stone-900 border border-stone-700 rounded-xl px-4 py-3 pr-11 text-stone-100 placeholder:text-stone-500 focus:outline-none focus:border-emerald-500/60 transition text-sm"
                />
                <button
                  type="button"
